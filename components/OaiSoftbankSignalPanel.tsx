    ...
    <section className="space-y-3">
      <div>
        ...
        <p className="text-sm" style={{ color: "var(--arb-text)", opacity: 0.8 }}>
          ...
          scale-in and take-profit are separate (hysteresis)
        </p>
      </div>
      <div className="grid gap-3 md:grid-cols-2">
        <TierTable
          title="Scale-in"
          caption="Add size when the print is this far from 8%"
        ...
        <TierTable
          title="Take-profit"
          caption="Reduce to this leverage as the print comes back toward 8%"
      ...
      <p className="text-xs" style={{ color: "var(--arb-text)", opacity: 0.7 }}>
        Above 8%: short OAI / long SoftBank. Below 8%: long OAI / short SoftBank.
        Legs paired in account dollars. Scale-in size is the gap to target, capped
        to paired book depth that still holds the entry rung. Flatten / TP does
        not wait on that spread — filling both legs comes first.
      </p>
    </section>
  );
}
